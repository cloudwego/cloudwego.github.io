...
自定义服务上报的注册信息，用法详见[服务发现](/zh/docs/kitex/tutorials/third-party/service_discovery/)。
...
指定一个 Registry 进行服务发现的注册上报，用法详见[服务发现](/zh/docs/kitex/tutorials/third-party/service_discovery/)。
