...
- Dynamicgo conv 选项
  Dynamicgo 需要设置自己的转换选项：`conv. Options`。json/超文本传输协议泛化调用的默认 `conv.Options` 如下：
...
https://github.com/cloudwego/kitex/blob/develop/pkg/generic/json_test/generic_test.go#L80
...
https://github.com/cloudwego/kitex/blob/develop/pkg/generic/http_test/generic_test.go#L96
