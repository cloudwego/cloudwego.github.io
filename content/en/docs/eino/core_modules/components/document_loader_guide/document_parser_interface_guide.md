...
- pdf parser, used for extracting and parsing PDF formatted files: [Parser - pdf](/en/docs/eino/ecosystem/document/parser_pdf)
- html parser, used for extracting and parsing HTML formatted content: [Parser - html](/en/docs/eino/ecosystem/document/parser_html)
