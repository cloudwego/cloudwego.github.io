...
An OpenSearch 3 retriever implementation for [Eino](https://github.com/cloudwego/eino) that implements the `Retriever` interface. This enables OpenSearch to seamlessly integrate into Eino's vector retrieval system, enhancing semantic search capabilities.
