...
3. Registration Center deregisters this service.
4. Shut down the signal listening of the network library
5. Uniformly add `Connection:Close` header to request packets in the process of closing
6. `Select` waits for the business coroutine to exit：
