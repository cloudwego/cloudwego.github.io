...
description: "Hertz provides [Request ID middleware](https://github.com/hertz-contrib/requestid) that can operate on `X-Request-ID`, inspired by gin's [implementation](https://github.com/gin-contrib/requestid)."
