...
Kitex users can add customized Tracers to deal with those events in the `Finish()` method. Refer to [Kitex - Tracing - Custom Tracer](https://www.cloudwego.io/docs/kitex/tutorials/observability/tracing/#customize-tracer) for more details.
