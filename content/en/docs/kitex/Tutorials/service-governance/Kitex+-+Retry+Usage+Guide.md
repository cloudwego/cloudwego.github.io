...
| **Configuration Item** | **Default Val** | **Description**                                                                                                                                                                                                                                                                                                       | **Legal value** |
| ---------------------- | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| MaxRetryTimes          | 2               | Maximum number of retries, excluding the first request. If configured to 0, it means stop retrying.                                                                                                                                                                                                                   | [0-5]           |
| MaxDurationMS          |                 | The cumulative maximum time consumption, including the first failed request and the retry requests. If time consumption reaches the limit, the subsequent retries will be stopped, and the unit is ms. 0 means no limit. Note: If configured, the configuration item must be greater than the request timed out time. |                 |
| StopPolicy.CBPolicy    | 10%             | Meaning varies according to retry.Container:<br><br>- Retry Percentage Limit, or<br><br>- Error Rate Limit; should be less than service-level circuit breaker threshold<br><br>Note: <br><br>- Method-level  threshold;<br><br>- If exceeded, no retry request will be sent;<br><br>- The default value is 10%.       | (0-30%]         |
| ChainStop              | true            | `Chain Stop` is enabled by default. If the upstream request is a retry request, it will not be retried.                                                                                                                                                                                                               |                 |
...
| **Configuration Item** | **Default Val** | **Description**                                                                                                                                                                                                                                                                                                 | **Legal value** |
| ---------------------- | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| RetryDelayMS           | -               | Duration of waiting for initiating a Backup Requset when the first request is not returned. This parameter must be set manually. It is suggested to be set as TP99.                                                                                                                                             |                 |
| MaxRetryTimes          | 1               | Maximum number of retries, excluding the first request. If configured to 0, it means stop retrying.                                                                                                                                                                                                             | [0-2]           |
| StopPolicy.CBPolicy    | 10%             | Meaning varies according to retry.Container:<br><br>- Retry Percentage Limit, or<br><br>- Error Rate Limit; should be less than service-level circuit breaker threshold<br><br>Note: <br><br>- Method-level  threshold;<br><br>- If exceeded, no retry request will be sent;<br><br>- The default value is 10%. | (0-30%]         |
| ChainStop              | true            | `Chain Stop` is enabled by default. If the upstream request is a retry request, it will not be retried.                                                                                                                                                                                                         |                 |
| RetrySameNode          | false           | If you want to retry on the same node, set this parameter to true.                                                                                                                                                                                                                                              |                 |
